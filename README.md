...
However, these two algorithms are too obscure ,and it's very hard to describe them accurately to make a steady algorithm for computers. To solve this problem, I came up with a algorithm which is easy to be described by programming languages (and I have made this come true by using Swift).
